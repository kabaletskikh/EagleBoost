 ...
 (function (a, b, c, d) {
     ...
     (function () {
         ...
         var g = function () {
             ...
             i = typeof Symbol === "function" && typeof(typeof Symbol === "function" ? Symbol.iterator : "@@iterator") === "symbol" ?
             function (a) {
                 return typeof a
             } : function (a) {
                 ...
                 (function () {
                     ...
                     var i = function () {
                         ...
                         },
                         {
                             key: "forceEndBatch",
                             value: function () {
                                 this._waitHandle != null && (g.clearTimeout(this._waitHandle), this._waitHandle = null),
                 ...
                 (function () {
                     ...
                     t = function () {
                         ...
                         },
                         {
                             ...
                             value: function (a) {
                                 u(new Error("Failed to check if the current pixel fired pcmInstagramTriggerAttribution plugin"));
         ...
         f.ensureModuleRegistered("SignalsFBEventsMobileAppBridge", function () {
             return function (g, h, j, k) {
                 ...
                 (function () {
                     ...
                     function s(a) {
                         var b = {};
                         if (a != null && (typeof a === "undefined" ? "undefined" : i(a)) === "object") for (var c in a) if (Object.prototype.hasOwnProperty.call(a, c)) {
                             var d = r(a[c]);
                             d != null && (b[q(c)] = d)
                         }
                         return b
             ...
             return function (f, g, j, k) {
                 ...
                 (function () {
                     ...
                     function w(a, b, c) {
                         ...
                         while (f < e) f in d && (c = b(c, d[f], f, a)),
                         f++;
                         return c
                     }
                     function x(a) {
                     ...
                     function A(a, b) {
                         try {
                             ...
                             if (a instanceof TypeError) if (B.test(a)) return null;
             ...
             return function (a, b, c, d) {
                 ...
                 (function () {
                     ...
                     function la(a, b, c) {
                         ...
                         if (P.call(T, c)) {
                             for (var d = 0, e = S.length; d < e; d++) if (S[d].id === c) {
                                 S[d][a] = b;
                                 break
                             }
                         } else M({
