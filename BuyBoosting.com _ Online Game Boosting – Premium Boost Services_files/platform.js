...
*/
    ...
    var Da = function (a, b) {
        ...
        Fa = function (a, b) {
            for (var c, d, e = 1; e < arguments.length; e++) {
                d = arguments[e];
                for (c in d) a[c] = d[c];
                for (var f = 0; f < Ea.length; f++) c = Ea[f],
    ...
    var cb = function (a) {
        Qa.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Ka, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(La, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Ma, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Na, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Oa, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(Pa, "&#0;")));
        return a
    };
...
/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var K = function (a, b, c) {
        ...
        Tb = function (a, b) {
            var c = [];
            if (a) for (var d in a) if (G(a, d) && null != a[d]) {
                var e = b ? b(a[d]) : a[d];
    ...
    var Zb = function (a, b, c, d) {
        ...
        bc = function (a) {
            if ($b()) a();
                ...
                C.addEventListener ? (C.addEventListener("load", c, !1), C.addEventListener("DOMContentLoaded", c, !1)) : C.attachEvent && (C.attachEvent("onreadystatechange", function () {
    ...
    rc.push(["jsl", function (a) {
        for (var b in a) if (G(a, b)) {
            var c = a[b];
    ...
    var sc = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Dc = function (a, b, c, d) {
            ...
            return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.U ? "/am=" + e(a.U) : "", a.$ ? "/rs=" + e(a.$) : "", a.ba ? "/t=" + e(a.ba) : "", "/cb=", e(c)].join("")
        },
        Bc = function (a) {
    ...
    var Gc = decodeURI("%73cript"),
        ...
        Jc = function () {
            var a = L.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(Hc) ? a : L.nonce = null : D.querySelector ? (a = D.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Hc) ? L.nonce = a : L.nonce = null) : null : null
        },
        Mc = function (a) {
        ...
        Nc = function (a, b) {
            var c = b && b._c;
            if (c) for (var d = 0; d < rc.length; d++) {
                var e = rc[d][0],
                    f = rc[d][1];
                f && G(c, e) && f(c[e], a, b)
            }
    ...
    var Sc = function (a) {
        ...
        O = function (a, b, c) {
            if (b && "object" === typeof b) for (var d in b)!Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Uc(a[d]) && !Uc(b[d]) ? O(a[d], b[d]) : b[d] && "object" === typeof b[d] ? (a[d] = Uc(b[d]) ? [] : {}, O(a[d], b[d])) : a[d] = b[d])
        },
        Vc = function (a) {
            if (a && !/^\s+$/.test(a)) {
        ...
        Xc = function (a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || "") : f = void 0, (f = Vc(f)) && b.push(f));
            a && Wc(c, a);
            d = Sc("cd");
            a = 0;
    ...
    var od, T, U = void 0,
        ...
        X = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                b = [];
                var e = W(a);
                if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== ud || a.constructor !== Array && a.constructor !== Object) && (e !== td || a.constructor !== Array && a.constructor !== Object) && e !== sd && e !== pd && e !== rd && e !== qd)) return X(a.toJSON.call(a), c);
                if (null == a) b[b.length] = "null";
                else if (e === pd) a = Number(a),
        ...
        Nd = function () {
            ...
            if ((void 0 === od || void 0 === U || T !== a) && -1 !== T) {
                ...
                try {
                    try {
                        U = !! p.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === p.JSON.stringify.call(p.JSON, {
                            a: [3, !0, new Date(0)],
                            c: function () {}
        ...
        Pd = function (a) {
            if (-1 !== T) return Nd(),
            U ? p.JSON.stringify.call(p.JSON, a) : X(a)
        },
    ...
    var Ud = function (a, b, c) {
        c || (c = 0);
        var d = a.ea;
        if ("string" === typeof b) for (var e = 0; 16 > e; e++) d[e] = b.charCodeAt(c) << 24 | b.charCodeAt(c + 1) << 16 | b.charCodeAt(c + 2) << 8 | b.charCodeAt(c + 3),
        c += 4;
        else for (e = 0; 16 > e; e++) d[e] = b[c] << 24 | b[c + 1] << 16 | b[c + 2] << 8 | b[c + 3],
        c += 4;
        for (e = 16; 80 > e; e++) {
    ...
    Td.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.l, d = 0, e = this.L, f = this.v; d < b;) {
                ...
                } else for (; d < b;) if (e[f] = a[d], ++f, ++d, f == this.l) {
                    Ud(this, e);
                    f = 0;
                    break
                }
    ...
    Td.prototype.digest = function () {
        ...
        for (var c = this.l - 1; 56 <= c; c--) this.L[c] = b & 255,
        b /= 256;
        Ud(this, this.L);
        for (c = b = 0; 5 > c; c++) for (var d = 24; 0 <= d; d -= 8) a[b] = this.g[c] >> d & 255,
        ++b;
        return a
    };
    var Vd = function () {
    ...
    Xd || (ae = 1E6 * (screen.width * screen.width + screen.height), be = de(D.cookie + "|" + D.location + "|" + (new Date).getTime() + "|" + Math.random()), Yd = S("random/maxObserveMousemove") || 0, 0 != Yd && Zb("mousemove", ce, "add", "at"));
    var ee = function () {
        var a = L.onl;
        if (!a) {
            a = F();
    ...
    var ie = {
        ...
        me = function (a, b, c, d, e) {
            ...
            try {
                ...
                f || (f = (a ? new yb(xb(a)) : ta || (ta = new yb)).ga("IFRAME"), g && (f.onload = function () {
                    f.onload = null;
                    g.call(this)
                }, he(d)))
            }
            f.setAttribute("ng-non-bindable", "");
            for (var k in c) a = c[k],
            "style" === k && "object" === typeof a ? H(a, f.style) : je[k] || f.setAttribute(k, String(a));
        ...
        Ee = function () {
            ...
            id(function (b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = ze(d, b, 0);
                        g ? (f = f.parentNode, e.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, De(f, b), (d = R[f.lastChild.id]) && (d.oid = c), jd(c, 4))) : delete R[c]
                    } else delete R[c]
                }
            })
        };
    var Fe, Ge, Y, He, Ie, Je = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        Ke = {
            plusone: !0,
            autocomplete: !0,
            profile: !0,
    ...
    var Me = function (a, b) {
        ...
        Le = function (a, b, c, d) {
            ...
            if (Ne(Ie || {})) for (var z in c) {
                ...
                d = [];
                for (z in c) for (a = c[z], q = 0, b = a.length; q < b; q++) e = a[q],
                Pe(z, e, Ce(e), d, b);
                Qe(u, d)
            }
        },
            ...
            case 1:
                if (b.parentNode) {
                    ...
                    if (h.forcePost || f && 2E3 < l.length) {
                        ...
                        k = [];
                        for (m = 0; m < l.length; m++) u = l[m].split("=", 2),
                        ...
                        for (e = 0; e < k.length; e++) l = b.createElement("input"),
                        l.type = "hidden",
                        l.name = k[e][0],
                        l.value = k[e][1],
                        f.appendChild(l);
    ...
    rc.push(["platform", function (a, b, c) {
        Ie = c;
        b && He.push(b);
        Xe(Se, a);
    ...
    var Ze = /^\{h:'/,
            ...
            function d(f) {
                ...
                if (bf(g, b)) {
                    ...
                    cf(a, function () {
                        k && M("rqd");
                        c();
                        for (var l = E(L, "RPMQ", []), m = 0; m < l.length; m++) l[m]({
                            data: g,
                            origin: h
                        })
                    })
        ...
        bf = function (a, b) {
            ...
            if (d.s && a && -1 != Cb.call(b, a)) {
                if ("_renderstart" === d.s || d.s === af + "/" + a + "::_renderstart") if (d = d.a && d.a[c ? 0 : 1], b = D.getElementById(a), jd(a, 2), d && b && d.width && d.height) {
                    a: {
                        c = b.parentNode;
                        a = d || {};
                        if (gd()) {
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.ru.OqPvIlocTL4.O/am\u003dAQ/d\u003d1/rs\u003dAGLTcCO-YaMEtFJeIYYsy0fa7Ipf00hZUQ/m\u003d__features__",
