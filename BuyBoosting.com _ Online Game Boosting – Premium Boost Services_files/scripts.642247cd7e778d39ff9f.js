var pJS = function (e, a) {
    ...
    i.fn.particlesUpdate = function () {
        for (var e = 0; e < i.particles.array.length; e++) {
            ...
            if (isInArray("grab", i.interactivity.events.onhover.mode) && i.fn.modes.grabParticle(a), (isInArray("bubble", i.interactivity.events.onhover.mode) || isInArray("bubble", i.interactivity.events.onclick.mode)) && i.fn.modes.bubbleParticle(a), (isInArray("repulse", i.interactivity.events.onhover.mode) || isInArray("repulse", i.interactivity.events.onclick.mode)) && i.fn.modes.repulseParticle(a), i.particles.line_linked.enable || i.particles.move.attract.enable) for (var s = e + 1; s < i.particles.array.length; s++) {
    ...
    i.fn.modes.bubbleParticle = function (e) {
        if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
            var a = e.x - i.interactivity.mouse.pos_x,
                ...
                n = 1 - (o = Math.sqrt(a * a + t * t)) / i.interactivity.modes.bubble.distance;

            function s() {
                e.opacity_bubble = e.opacity,
                e.radius_bubble = e.radius
            }
            if (o <= i.interactivity.modes.bubble.distance) {
                if (n >= 0 && "mousemove" == i.interactivity.status) {
                    var r, c;
                    i.interactivity.modes.bubble.size != i.particles.size.value && (i.interactivity.modes.bubble.size > i.particles.size.value ? (r = e.radius + i.interactivity.modes.bubble.size * n) >= 0 && (e.radius_bubble = r) : e.radius_bubble = (r = e.radius - (e.radius - i.interactivity.modes.bubble.size) * n) > 0 ? r : 0),
                    i.interactivity.modes.bubble.opacity != i.particles.opacity.value && (i.interactivity.modes.bubble.opacity > i.particles.opacity.value ? (c = i.interactivity.modes.bubble.opacity * n) > e.opacity && c <= i.interactivity.modes.bubble.opacity && (e.opacity_bubble = c) : (c = e.opacity - (i.particles.opacity.value - i.interactivity.modes.bubble.opacity) * n) < e.opacity && c >= i.interactivity.modes.bubble.opacity && (e.opacity_bubble = c))
                }
            } else s();
            ...
            if (i.tmp.bubble_clicking) {
                ...
                var o = Math.sqrt(a * a + t * t),
                    l = ((new Date).getTime() - i.interactivity.mouse.click_time) / 1e3;
                l > i.interactivity.modes.bubble.duration && (i.tmp.bubble_duration_end = !0),
                l > 2 * i.interactivity.modes.bubble.duration && (i.tmp.bubble_clicking = !1, i.tmp.bubble_duration_end = !1)
            }
            function v(a, t, n, s, r) {
                if (a != t) if (i.tmp.bubble_duration_end) null != n && (v = a + (a - (s - l * (s - a) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = v), "opacity" == r && (e.opacity_bubble = v));
                else if (o <= i.interactivity.modes.bubble.distance) {
                    if (null != n) var c = n;
                    else c = s;
                    if (c != a) {
                        var v = s - l * (s - a) / i.interactivity.modes.bubble.duration;
                        "size" == r && (e.radius_bubble = v),
                        "opacity" == r && (e.opacity_bubble = v)
                    }
                } else "size" == r && (e.radius_bubble = void 0),
                "opacity" == r && (e.opacity_bubble = void 0)
            }
            i.tmp.bubble_clicking && (v(i.interactivity.modes.bubble.size, i.particles.size.value, e.radius_bubble, e.radius, "size"), v(i.interactivity.modes.bubble.opacity, i.particles.opacity.value, e.opacity_bubble, e.opacity, "opacity"))
        }
    },
    ...
    i.fn.vendors.densityAutoParticles = function () {
        if (i.particles.number.density.enable) {
            ...
            var a = i.particles.array.length - e * i.particles.number.value / i.particles.number.density.value_area;
    ...
    i.fn.vendors.drawShape = function (e, a, t, i, n, s) {
        ...
        e.translate(a, t),
        e.moveTo(0, 0);
        for (var l = 0; l < r; l++) e.lineTo(i, 0),
        e.translate(i, 0),
        e.rotate(o);
        e.fill(),
        e.restore()
