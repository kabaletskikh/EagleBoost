/*1623566912,,JIT Construction: v1003960439,en_US*/
 ...
 */
 try {
          ...
          for (var i = 0; i < sandboxWhitelist.length; i++) {
              ...
              with(this) {
                                  ...
                                  if (!s("json")) {
                                      ...
                                      if (!s("json-stringify")) {
                                          var D = {
                                              ...
                                              I = function (a, b, c, d, e, f, g) {
                                                  ...
                                                  if (typeof h == "object") {
                                                      ...
                                                      f += e;
                                                      if (i == x) {
                                                          for (m = 0, j = h.length; m < j; m++) s = I(m, h, c, d, e, f, g),
                                                          B.push(s === q ? "null" : s);
                                                          t = B.length ? e ? "[\n" + f + B.join(",\n" + f) + "\n" + k + "]" : "[" + B.join(",") + "]" : "[]"
                                          ...
                                          a.stringify = function (a, b, d) {
                                              var e, f, g, h;
                                              if (c[typeof b] && b) if ((h = n.call(b)) == t) f = b;
                                              else if (h == x) {
                                                  g = {};
                                      ...
                                      if (!s("json-parse")) {
                                          var J = g.fromCharCode,
                                                      ...
                                                      case 34:
                                                          for (c = "@", L++; L < b;) {
                                                              ...
                                                              if (g < 32) N();
                                                                  ...
                                                                  case 117:
                                                                      d = ++L;
                                                                      for (e = L + 4; L < e; L++) g = a.charCodeAt(L),
                                              ...
                                              R = function (a, b, c) {
                                                  var d = a[b],
                                                      e;
                                                  if (typeof d == "object" && d) if (n.call(d) == x) for (e = d.length; e--;) Q(d, e, c);
                                                  else p(d, function (a) {
                                                      Q(d, a, c)
                                                  });
                                                  return c.call(a, b, d)
                  ...
                  __d("ES", ["ES5FunctionPrototype", "ES5StringPrototype", "ES6Array", "ES6ArrayPrototype", "ES6Number", "ES6Object", "ES7ArrayPrototype", "ES7Object", "ES7StringPrototype", "json3"], (function (a, b, c, d, e, f) {
                      ...
                      function c(a, b, c) {
                          var d = c ? g.call(a).slice(8, -1) + ".prototype" : a,
                              e;
                          if (Array.isArray(a)) if (typeof d === "string") e = h[d + "." + b];
                  ...
                  __d("Assert", ["AssertionError", "sprintf"], (function (a, b, c, d, e, f) {
                      function g(a, c) {
                          if (typeof a !== "boolean" || a === !1) throw new(b("AssertionError"))(c);
                          return a
                      }
                      function h(a, c, d) {
                          var e;
                      ...
                      function a(a, b, c) {
                          g(b instanceof a, (a = c) != null ? a : "Expression not instance of type");
                          return b
                      }
                      function i(a, b) {
                          j["is" + a] = b,
                  ...
                  __d("Type", ["Assert"], (function (a, b, c, d, e, f) {
                      ...
                      function j(a, c, d) {
                          ...
                          e.prototype.parent = function () {
                              this.parent = a.prototype.parent,
                              a.apply(this, arguments)
                          };
                  ...
                  __d("sdk.ErrorHandler", ["ManagedError", "normalizeError", "sdk.Runtime", "wrapFunction"], (function (a, b, c, d, e, f) {
                      f.create = a;
                          ...
                          function f(c, f) {
                              return function () {
                                  ...
                                  try {
                                      ...
                                      if (!g.script) {
                                          var h = /.*\/([^?#]+)/.exec(b("sdk.Runtime").getSDKUrl());
                                          g.script = h !== null ? h[1] : ""
                                      }
                                      g.entry = f;
                  ...
                  __d("sdk.FeatureFunctor", [], (function (a, b, c, d, e, f) {
                      ...
                      function g(a, b, c) {
                          if (a.features && b in a.features) {
                              a = a.features[b];
                              if (typeof a === "object" && typeof a.rate === "number") if (a.rate && Math.random() * 100 <= a.rate) return a.value || !0;
                  ...
                  __d("FB", ["DOMWrapper", "GlobalCallback", "JSSDKCssConfig", "Log", "dotAccess", "sdk.Content", "sdk.DOM", "sdk.ErrorHandling", "sdk.domReady"], (function (a, b, c, d, e, f) {
                      ...
                      b("sdk.domReady")(function () {
                          ...
                          b("JSSDKCssConfig").rules && b("sdk.DOM").addCssRules(b("JSSDKCssConfig").rules, b("JSSDKCssConfig").components)
                      });
                              ...
                              if (!f) {
                                  ...
                                  for (var l = 0; l < k.length - 1; l++) {
                                      ...
                                      if (m) {
                                          ...
                                          g = g[m]
                                      } else k[l + 1] && !k[l + 1].match(/^\d{1,3}$/) ? g.push({}) : g.push([]),
                                      g = g[g.length - 1]
                                  }
                  ...
                  __d("PHPStrictQuerySerializer", ["PHPQuerySerializer", "flattenPHPQueryData"], (function (a, b, c, d, e, f) {
                      f.serialize = a;
                      f.encodeComponent = h;
                      var g;
                  ...
                  __d("CORSRequest", ["Log", "QueryString", "RequestConstants", "sdk.Cookie", "sdk.safelyParseResponse", "wrapFunction"], (function (a, b, c, d, e, f) {
                      function g(a, c) {
                          ...
                          var d = new XMLHttpRequest(),
                              e = function () {};
                          if ("withCredentials" in d) d.open(a, c, !0),
                      ...
                      function a(a, c, d, e) {
                          ...
                          try {
                              if (self.document) {
                                  ...
                                  f && (a = b("QueryString").appendToUrl(a, b("QueryString").encode({
                                      __cppo: f
                                  })))
                              }
                          } catch (a) {}
                          ...
                          d.onerror = function (c) {
                              c.responseText ? e(b("sdk.safelyParseResponse")(c.responseText, a, c.status)) : e({
                  ...
                  __d("sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature", "sdk.warnInsecure"], (function (a, b, c, d, e, f) {
                      ...
                      function a(a) {
                          ...
                          if (typeof a === "string") if (b("sdk.Runtime").getIsVersioned()) {
                  ...
                  __d("FBEventsUtils", [], (function (a, b, c, d, e, f) {
                      ...
                      function a(a, b, c) {
                          var d = g ? "on" + b : b;
                          b = function b() {
                              g ? a.detachEvent && a.detachEvent(d, b) : a.removeEventListener(d, b, !1),
                              c()
                          };
                      ...
                      function a(a) {
                          ...
                          if (document.attachEvent) {
                              ...
                              window.setTimeout(function () {
                                  ...
                                  typeof a.onInsert === "function" && a.onInsert(a.root.firstChild)
                              }, 0)
                          } else {
                  ...
                  __d("sdk.Impressions", ["Miny", "QueryString", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.Runtime", "sdk.feature"], (function (a, b, c, d, e, f) {
                      ...
                      function h(a, c, d, e) {
                          ...
                          if (c.length <= 2e3) window.fetch(c, f);
                              ...
                              for (var g in d) if (Object.prototype.hasOwnProperty.call(d, g)) {
                                  c = d[g];
                  ...
                  __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function (a, b, c, d, e, f) {
                      ...
                      function y(a) {
                          b("Assert").isTrue(a.length !== 0, "User ID must be set before updateUserProperties can be called."),
                          b("Assert").isTrue(a.length <= n, "Invalid user ID: " + a + ". It must be no longer than " + n + " characters.")
                      }
                      function d(a) {
                          y(a),
                          s.setUserID(a)
                      ...
                      function E(a) {
                          b("Assert").isTrue(Object.keys(a).length <= p, "The total number of user properties cannot exceed " + p + ".");
                          for (var c in a) b("Assert").isTrue(l.test(c) || ES(r, "includes", !0, c), "Invalid user properties key name: " + c + ". It must be between 1 and " + m + " characters, and must contain only alphanumerics, _, - or spaces, starting with alphanumeric or _. Or, it must be a pre-defined user property"),
                          b("Assert").isTrue(a[c].toString().length <= q, "Invalid user properties value: " + a[c] + ". It must be no longer than " + q + " characters.")
                      }
                      function F(a, c, d) {
                          var e = z();
                          y(e);
                  ...
                  __d("sdk.AuthState", [], (function (a, b, c, d, e, f) {
                      "use strict";
                      var g = h();
                  ...
                  __d("sdk.Observable", [], (function (a, b, c, d, e, f) {
                      a = function () {
                          function a() {
                              this.$1 = {},
                              this.getSubscribers = ES(this.getSubscribers, "bind", !0, this),
                              this.clearSubscribers = ES(this.clearSubscribers, "bind", !0, this),
                  ...
                  __d("sdk.AuthUtils", ["sdk.AuthState", "sdk.Cookie", "sdk.Observable", "sdk.Runtime"], (function (a, b, c, d, e, f) {
                      "use strict";
                      ...
                      function e(a) {
                          a != null ? (b("sdk.Runtime").setGraphDomain(a), a == "instagram" && b("sdk.Runtime").setIsVersioned(!1)) : b("sdk.Runtime").setGraphDomain("")
                      }
                      function h() {
                          b("sdk.Cookie").setRaw(p.LOGOUT_COOKIE_PREFIX, "y", Date.now() + g, !1)
                      }
                      function i() {
                  ...
                  __d("sdk.AuthStorageUtils", ["sdk.AuthUtils", "sdk.Runtime", "sdk.WebStorage", "sdk.feature"], (function (a, b, c, d, e, f) {
                      "use strict";
                      ...
                      function a(a, c) {
                          if (g() && c != null && c !== "") {
                              ...
                              if (d) {
                                  a = b("sdk.AuthUtils").isInstagramLogin(a) ? b("sdk.AuthUtils").AuthConstants.IG_LOCAL_STORAGE_TOKEN_PREFIX : b("sdk.AuthUtils").AuthConstants.LOCAL_STORAGE_TOKEN_PREFIX;
                      ...
                      function c(a) {
                          ...
                          c && (a === "instagram" ? c.removeItem(b("sdk.AuthUtils").AuthConstants.IG_LOCAL_STORAGE_TOKEN_PREFIX + b("sdk.Runtime").getClientID()) : c.removeItem(b("sdk.AuthUtils").AuthConstants.LOCAL_STORAGE_TOKEN_PREFIX + b("sdk.Runtime").getClientID()))
                      }
                      function d(a, c) {
                          if (!g()) return;
                          var d = b("sdk.WebStorage").getSessionStorage();
                          d && d.setItem(b("sdk.AuthUtils").AuthConstants.SESSION_STORAGE_LOGIN_STATUS_PREFIX + b("sdk.Runtime").getClientID(), ES("JSON", "stringify", !1, {
                              authResponse: a,
                              status: c,
                              expiresAt: a != null && a.expiresIn && a.expiresIn !== 0 ? Date.now() + Math.min(a.expiresIn * .75 * 1e3, b("sdk.AuthUtils").AuthConstants.CONNECTED_REVALIDATE_PERIOD) : Date.now() + b("sdk.AuthUtils").AuthConstants.DEFAULT_REVALIDATE_PERIOD
                          }))
                      }
                      function g() {
                          return b("sdk.feature")("cache_auth_response", !1) && b("sdk.Runtime").getUseLocalStorage() && location.protocol === "https:"
                      }
                      function e() {
                          var a = null,
                              c = null;
                          if (b("sdk.Runtime").getUseLocalStorage()) {
                              ...
                              d && (a = d.getItem(b("sdk.AuthUtils").AuthConstants.LOCAL_STORAGE_TOKEN_PREFIX + b("sdk.Runtime").getClientID()), c = d.getItem(b("sdk.AuthUtils").AuthConstants.IG_LOCAL_STORAGE_TOKEN_PREFIX + b("sdk.Runtime").getClientID()))
                          }
                          return {
                              fbToken: a,
                              igToken: c
                      ...
                      function h() {
                          ...
                          if (a) {
                              a = a.getItem(b("sdk.AuthUtils").AuthConstants.SESSION_STORAGE_LOGIN_STATUS_PREFIX + b("sdk.Runtime").getClientID());
                              if (a != null) try {
                                  a = ES("JSON", "parse", !1, a);
                  ...
                  __d("sdk.statusCORS", ["Log", "UrlMap", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature", "sdk.getContextType"], (function (a, b, c, d, e, f) {
                      "use strict";
                      var g = 6e4,
                          h = 114;
                      ...
                      function a(a, c, d, e) {
                          ...
                          function o() {
                              ...
                              c && (c.open("GET", f.toString(), !0), c.withCredentials = !0, c.onreadystatechange = function () {
                                  if (c.readyState === 4) {
                                      if (b("sdk.feature")("e2e_ping_tracking", !0)) {
                                          ...
                                          b("sdk.Impressions").log(h, {
                                              payload: f
                                          })
                                      }
                                      if (c.status === 200) {
                                          i(a, (f = c.getResponseHeader("fb-s")) != null ? f : "unknown", (f = c.getResponseHeader("fb-ar")) != null ? f : "{}", e)
                                      } else j(a, c.status, d, e)
                                  }
                              }, c.send())
                          }
                          function p() {
                              m(e) || window.setTimeout(function () {
                          ...
                          function q() {
                              window.fetch(f.toString(), {
                                  ...
                                  if (b("sdk.AuthState").getState().shouldSecondLoginRequestTimeOut) {
                                      b("sdk.AuthState").setState({
                                          shouldSecondLoginRequestTimeOut: !1
                                      });
                                      return
                                  ...
                                  if (c.status === 200) {
                                      var f;
                                      i(a, (f = c.headers.get("fb-s")) != null ? f : "unknown", (f = c.headers.get("fb-ar")) != null ? f : "{}", e)
                                  } else j(a, c.status, d, e)
                              })["catch"](function (c) {
                                  if (b("sdk.AuthState").getState().shouldSecondLoginRequestTimeOut) {
                                      b("sdk.AuthState").setState({
                      ...
                      function i(a, c, d, e) {
                          ...
                          case "connected":
                              ...
                              d.data_access_expiration_time != null && (f.data_access_expiration_time = Number(d.data_access_expiration_time));
                              d.base_domain != null && b("sdk.AuthUtils").setBaseDomain(d.base_domain);
                              b("sdk.AuthUtils").setGraphDomain(d.graph_domain);
                              b("sdk.AuthStorageUtils").setLocalStorageToken(f, d.long_lived_token);
                              ...
                              b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT, d);
                              break;
                          case "not_authorized":
                          case "unknown":
                          default:
                              ...
                              b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT, f)
                          }
                      }
                      function j(a, c, d, e) {
                          e === void 0 && (e = "facebook");
                          c === 0 ? (b("sdk.feature")("cors_status_fetch_cancel_tracking", !1) && b("sdk.Scribe").log("jssdk_error", {
                              appId: b("sdk.Runtime").getClientID(),
                              ...
                              extra: {
                                  message: "HTTP Status Code " + c
                              }
                          }), b("Log").error("Error retrieving login status, HTTP status code: " + c));
                          c = k();
                          if (c && c === e) {
                              c = {
                                  authResponse: d,
                              ...
                              b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT, c)
                          } else {
                              d = {
                                  authResponse: null,
                                  status: "unknown",
                      ...
                      function k() {
                          ...
                          return a ? b("sdk.AuthUtils").isInstagramLogin(a) ? "instagram" : "facebook" : null
                      }
                      function l(a) {
                      ...
                      function m(a) {
                          ...
                          switch (a) {
                          case "facebook":
                              return (c == null ? void 0 : c.fbLoginStatus) === null && (c == null ? void 0 : c.igLoginStatus) !== null;
                          case "instagram":
                              return (c == null ? void 0 : c.igLoginStatus) === null && (c == null ? void 0 : c.fbLoginStatus) !== null;
                          default:
                              return !1
                          }
                      }
                      function n(a) {
                          var c = b("sdk.AuthState").getState().mixedAuthState;
                          if ((c == null ? void 0 : c.fbLoginStatus) != null && (c == null ? void 0 : c.igLoginStatus) != null) return;
                          c = {
                              authResponse: null,
                              status: "unknown",
                              loginSource: a
                          };
                          b("sdk.AuthUtils").AuthInternalEvent.inform("xFoAFetchCompleted", c)
                      }
                      c = {
                  ...
                  __d("sdk.Auth", ["Log", "QueryString", "UrlMap", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Frictionless", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.feature", "sdk.statusCORS"], (function (a, b, c, d, e, f) {
                      b("sdk.Frictionless");
                      var g = 5 * 1e3,
                          h = 117,
                          i = /^https?:\/\/([\w\.]+)?\.facebook\.com\/?/;
                      b("sdk.Runtime").subscribe("AccessToken.change", function (a) {
                          !a && b("sdk.Runtime").getLoginStatus() === "connected" && x.getLoginStatus(null, !0)
                      });
                      ...
                      function k(a) {
                          ...
                          b("sdk.AuthUtils").AuthInternalEvent.clearSubscribers(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT);
                          b("sdk.AuthUtils").AuthInternalEvent.clearSubscribers(b("sdk.AuthUtils").AuthConstants.XFOA_FINAL_RESPONSE_EVENT)
                      }
                      function l(a, c, d, e) {
                          d === void 0 && (d = "facebook");
                          e === void 0 && (e = !1);
                          ...
                          if (a != null) {
                              ...
                              if (a.userID != null && a.userID !== "") h = a.userID;
                                  ...
                                  i != null && i !== "" && i.user_id != null && i.user_id !== "" && (h = i.user_id)
                              }
                              ...
                              if (b("sdk.Runtime").getUseLocalStorage()) {
                                  b("sdk.AuthStorageUtils").removeLocalStorageToken((i = d) != null ? i : "facebook")
                              }
                          }
                          i = g === "unknown" && a != null || b("sdk.Runtime").getUseCookie() && b("sdk.Runtime").getCookieUserID() !== h;
                          ...
                          (j || f) && b("sdk.AuthUtils").AuthInternalEvent.inform("logout", h);
                          (i || f) && b("sdk.AuthUtils").AuthInternalEvent.inform("login", h);
                          k && b("sdk.AuthUtils").AuthInternalEvent.inform("authresponse.change", h);
                          g && b("sdk.AuthUtils").AuthInternalEvent.inform("status.change", h);
                      ...
                      function a(a) {
                          var c = m(),
                              d = b("sdk.AuthUtils").isInstagramLogin(c) ? "instagram" : "facebook";
                          l(null, "unknown", d);
                          b("sdk.AuthUtils").setLogoutState();
                          if (c != null && c.accessToken != null) {
                              d = new(b("sdk.URI"))(b("UrlMap").resolve("www").replace("web.", "www.") + "/x/oauth/logout").addQueryData("access_token", c.accessToken);
                              var e = new XMLHttpRequest();
                              e && (e.open("GET", d.toString(), !0), e.withCredentials = !0, a && (e.onreadystatechange = function () {
                                  e.readyState >= 2 && a({
                                      authResponse: m(),
                                      status: b("sdk.Runtime").getLoginStatus()
                                  })
                      ...
                      function c(a, c, d, e) {
                          return function (d) {
                              ...
                              l(c, f),
                              n(e);
                              else if (d && (d.error || d.error_message || d.error_description || d.error_code || d.error_reason || d.result && d.result.closeWindow)) {
                                  b("sdk.AuthUtils").setLogoutState();
                                  f = "unknown";
                                  l(null, f);
                                  ...
                                  d.error === "access_denied" || d.result && d.result.closeWindow ? b("sdk.AuthUtils").AuthInternalEvent.inform("loginDenied", f) : b("sdk.AuthUtils").AuthInternalEvent.inform("loginError", f)
                              } else d && d.result && (b("sdk.AuthUtils").removeLogoutState(), c = d.result.authResponse);
                              if (a) {
                                  g = {
                                      authResponse: c,
                                      status: b("sdk.Runtime").getLoginStatus(),
                      ...
                      function o(a, c) {
                          ...
                          c.base_domain != null && b("sdk.AuthUtils").setBaseDomain(c.base_domain);
                          ...
                          b("sdk.AuthStorageUtils").setLocalStorageToken(a, c.long_lived_token);
                          return a
                      }
                      function p(a) {
                          var b = "unknown";
                      ...
                      function r(a) {
                          var c = null,
                              d = !1;
                          if (b("sdk.Runtime").getLoginStatus() !== "connected" && (document.referrer === "" || i.test(document.referrer))) {
                              ...
                              if (e !== "") {
                                  ...
                                  if (window == top && c != null) {
                                      ...
                                      a = function (a) {
                                          var d;
                                          a != null && a.status === "connected" && ((d = a.authResponse) == null ? void 0 : d.accessToken) === c && (delete f.access_token, delete f.code, delete f.signed_request, location.hash = b("QueryString").encode(f), g != null && a.authResponse != null && (a.authResponse.signedRequest = g));
                                          h != null && h(a)
                                      }
                                  }
                              }
                          ...
                          return {
                              access_token: c,
                              redirect_cancelled: d
                          }
                      }
                      function s() {
                          return b("sdk.UA").isSupportedIABVersion(parseFloat(b("sdk.feature")("iab_login_android_support_version", "999.0"))) && window.FBLogin && typeof window.FBLogin.showFBLoginBottomSheetInIAB === "function" && b("sdk.feature")("iab_login_status", !1)
                      }
                      function t(a, c, d) {
                      ...
                      function u(a) {
                          ...
                          c && (window.clearTimeout(c), b("sdk.AuthState").setState({
                              timer: null
                          }));
                          b("sdk.AuthUtils").resetFBAndIGLoginStatus();
                          c = b("sdk.Cookie").getRaw(b("sdk.AuthUtils").AuthConstants.LOGOUT_COOKIE_PREFIX) === "y";
                          var d = r(a),
                              e = d.access_token;
                          ...
                          d = c.fbToken;
                          c = c.igToken;
                          e != null && (ES(e, "startsWith", !0, "IG") ? c = e : d = e);
                          !b("sdk.Runtime").getShouldLoadFamilyLogin() ? b("sdk.AuthUtils").AuthInternalEvent.subscribe(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT, k) : b("sdk.Runtime").getFamilyLoginLoaded() ? b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.LOAD_XFOA_SUBSCRIBERS) : b("sdk.Runtime").subscribe("FamilyLoginLoaded.change", function (a) {
                              a && b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.LOAD_XFOA_SUBSCRIBERS)
                          });
                          s() ? t(a, d) : v(d, c, a)
                      }
                      function v(a, c, d) {
                          b("sdk.statusCORS").getLoginStatusCORS(d, a, b("sdk.AuthState").getState().currentAuthResponse, "facebook");
                          if (b("sdk.Runtime").getShouldLoadFamilyLogin()) if (c != null) b("sdk.statusCORS").getLoginStatusCORS(d, c, b("sdk.AuthState").getState().currentAuthResponse, "instagram");
                          else {
                              a = {
                                  authResponse: null,
                                  status: "unknown",
                              ...
                              b("sdk.AuthUtils").AuthInternalEvent.inform(b("sdk.AuthUtils").AuthConstants.CORS_FETCH_COMPLETED_EVENT, a)
                          }
                      }
                      function w(a) {
                          a === void 0 && (a = b("sdk.AuthUtils").AuthConstants.CONNECTED_REVALIDATE_PERIOD);
                          var c = b("sdk.AuthState").getState().timer;
                      ...
                      function d(a, c) {
                          ...
                          d = b("sdk.Runtime").getLoginStatus() !== "connected" && i.test(document.referrer) && location.hash.indexOf("cb=") > -1;
                          if (!d && !c) {
                              ...
                              if (d != null) {
                                  ...
                                  l(d.authResponse, (e = d.status) != null ? e : "unknown", "facebook", !0);
                                  w(d.status === "connected" ? b("sdk.AuthUtils").AuthConstants.CONNECTED_REVALIDATE_PERIOD : b("sdk.AuthUtils").AuthConstants.DEFAULT_REVALIDATE_PERIOD)
                              }
                          }
                          if (!c) if (b("sdk.AuthState").getState().loadState === "loaded") {
                              if (a) {
                                  e = {
                                      authResponse: m(),
                                      status: b("sdk.Runtime").getLoginStatus()
                              ...
                              return
                          } else if (b("sdk.AuthState").getState().loadState === "loading") {
                              a && b("sdk.AuthUtils").AuthInternalEvent.subscribe("FB.loginStatus", a);
                              return
                          }
                          a && b("sdk.AuthUtils").AuthInternalEvent.subscribe("FB.loginStatus", a);
                          b("sdk.AuthState").setState({
                          ...
                          d = function (a) {
                              ...
                              b("sdk.AuthUtils").AuthInternalEvent.inform("FB.loginStatus", a),
                              b("sdk.AuthUtils").AuthInternalEvent.clearSubscribers("FB.loginStatus")
                          };
                          u(d)
                      }
                      var x = {
                      ...
                      a = function () {
                          ...
                          c.read = function (a, c) {
                              ...
                              try {
                                  ...
                                  b("Log").error("Invokation of RPC method %s resulted in the error: %s", a.method, c.message),
                                  g("error", {
                                      code: -32603,
                  ...
                  __d("Queue", [], (function (a, b, c, d, e, f) {
                      ...
                      a = function () {
                          ...
                          b._dispatch = function (a) {
                              ...
                              if (c != null) a.call(this, this._queue.shift()),
                  ...
                  __d("sdk.DialogUtils", ["DOMEventListener", "sdk.Content", "sdk.DOM", "sdk.UA"], (function (a, b, c, d, e, f) {
                      ...
                      function d(a, c, d) {
                          ...
                          return b("DOMEventListener").add(a, "mouseenter", function () {
                              ...
                              f || (f = b("DOMEventListener").add(a, "mouseleave", function () {
                                  g()
                              }))
                          })
                      }
                      ...
                      function k(a, c, d) {
                          ...
                          if (b("sdk.UA").mobile()) {
                              ...
                              } else b("sdk.DOM").addCss(document.body, "fb_hidden"),
                      ...
                      var m = b("Type").extend({
                          ...
                          n = {
                              ...
                              _hideTabletOverlay: function () {
                                  n.isTabletStyle() && (n._overlayEl != null && (n._overlayEl.className = "hidden"), n._overlayListeners.forEach(function (a) {
                                      return a.remove()
                                  }), n._overlayListeners = [])
                              },
                              ...
                              _makeActive: function (a) {
                                  ...
                                  n._lowerActive(),
                                  n._active = a,
                                  b("sdk.Runtime").isEnvironment(b("sdk.Runtime").ENVIRONMENTS.CANVAS) && b("sdk.Canvas.Environment").getPageInfo(function (a) {
                                      n._centerActive(a)
                                  }),
                                  n._centerActive()
                              },
                              ...
                              _setDialogSizes: function (a) {
                                  ...
                                  for (var c in n._dialogs) if (Object.prototype.hasOwnProperty.call(n._dialogs, c)) {
                              ...
                              _handleOrientationChange: function () {
                                  ...
                                  if (n.isTabletStyle()) n._setDialogSizes(!0),
                                  n._centerActive(),
                      ...
                      a = {
                          onready: function (a) {
                              ...
                              if (this.nativeReady) a();
                                  ...
                                  var c = function b() {
                                      window.removeEventListener(g, b),
                                      this.onready(a)
                                  };
                  ...
                  __d("sdk.Popup", ["sdk.Content", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.feature"], (function (a, b, c, d, e, f) {
                      "use strict";
                      f.popup = a;
                      ...
                      function a(a, c) {
                          var d = g({
                              ...
                              e;
                          a.post ? (e = window.open("about:blank", a.id, d), e && b("sdk.Content").submitToTarget({
                              url: a.url,
                              target: a.id,
                              params: a.params
                          })) : e = window.open(a.url, a.id, d);
                          if (!e && b("sdk.feature")("popup_blocker_scribe_logging", !0)) {
                      ...
                      function g(a) {
                          ...
                          d.push("top=" + e);
                          d.push("scrollbars=1");
                          a.isOAuth && (d.push("toolbar=0"), (!b("sdk.UA").chrome() || b("sdk.UA").chrome() < 59) && d.push("location=1"));
                          return d.join(",")
                      }
                  }), null);
                  ...
                  __d("sdk.XD", ["JSSDKXDConfig", "Log", "QueryString", "Queue", "UrlMap", "guid", "isFacebookURI", "isInstagramURI", "resolveWindow", "sdk.Event", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function (a, b, c, d, e, f) {
                      var g = new(b("Queue"))(),
                          h = "parent",
                          i = null,
                      ...
                      c = function () {
                          if ("origin" in location) if (location.origin && location.origin != "null") return location.origin;
                      ...
                      function p(a) {
                          ...
                          b("sdk.Runtime").setEnvironment(a === "canvas" ? b("sdk.Runtime").ENVIRONMENTS.CANVAS : b("sdk.Runtime").ENVIRONMENTS.PAGETAB)
                      }
                      function q(a, c) {
                          if (!c) {
                      ...
                      function r(a, c) {
                          if (c != null && c !== "native" && !b("isFacebookURI")(new(b("sdk.URI"))(c)) && !b("isInstagramURI")(new(b("sdk.URI"))(c))) return;
                          if (typeof a === "string") {
                              if (/^FB_RPC:/.test(a)) {
                      ...
                      function u(a) {
                          ...
                          e = window.setInterval(function () {
                              if (!g.isStarted() && f > 0) f--,
                              b("Log").debug("resending xdArbiterRegister"),
                              h();
                              else {
                  ...
                  __d("sdk.modFeatureCheck", ["JSSDKConfig"], (function (a, b, c, d, e, f) {
                      ...
                      function a(a, c, d) {
                          d === void 0 && (d = !1);
                          if (b("JSSDKConfig").features && a in b("JSSDKConfig").features) {
                              var e = b("JSSDKConfig").features[a];
                              if (typeof e === "object" && Array.isArray(e)) return c.some(function (a) {
                  ...
                  __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.Impressions", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function (a, b, c, d, e, f) {
                      var g = {
                          ...
                          getXdRelation: function (a) {
                              var b = a.display;
                              return b === "touch" && window.postMessage && a.in_iframe ? "parent" : o.getXdRelation(a)
                          }
                      };
  
                      function h(a) {
                          return o.isOAuth(a) && b("sdk.Extensions").supportsDialog("oauth")
                      }
                      function i(a) {
                          return o.isOAuth(a) && (a.is_account_link === !0 || a.is_account_link === "true") && b("sdk.Extensions").supportsDialog("accountLink")
                      }
                      function j(a) {
                          ...
                          a.params.fx_app === "instagram" && !a.params.scope && (a.params.scope = "public_profile");
                          ...
                          f = Object.keys(ES("Object", "assign", !1, a.params.response_type ? b("createObjectFrom")(a.params.response_type.split(",")) : {}, f)).join(",");
                          a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                              client_id: b("sdk.Runtime").getClientID(),
                              origin: b("sdk.getContextType")(),
                              response_type: f,
                              domain: location.hostname
                          }), a.cb = b("sdk.Auth").xdResponseWrapper(c, b("sdk.Auth").getAuthResponse(), "permissions.oauth", a.params)) : (e && o._xdNextHandler(function (a) {
                              c({
                                  authResponse: null,
                              ...
                              client_id: b("sdk.Runtime").getClientID(),
                              redirect_uri: b("resolveURI")(o.xdHandler(c, d, a.params.plugin_prepare ? "opener.parent" : "opener", b("sdk.Auth").getAuthResponse(), "permissions.oauth", !e, a.params)),
                              origin: b("sdk.getContextType")(),
                              response_type: f,
                              domain: location.hostname
                          }));
                          ...
                          !a.params.plugin_prepare && !e && b("sdk.Impressions").log(117, {
                              payload: d
                          });
                          return a
                      }
                      ...
                      var o = {
                          ...
                          isOAuth: function (a) {
                              return o._oauthMethodNameSet.has(a.method) || a.method == "oauth"
                          },
                          ...
                          prepareCall: function (a, c) {
                              ...
                              if (e.url == "dialog/oauth") {
                                  if (l >= ((g = b("sdk.feature")("max_oauth_dialog_retries", 100)) != null ? g : 100)) {
                                      b("Log").error("Your request to oauth has exceeded the rate limit, please try again later");
                                      return
                                  }
                                  l++
                              }
                              ...
                              g = {
                                  ...
                                  url: b("UrlMap").resolve(a.fx_app === "instagram" ? "www_instagram" : a.display == "touch" ? "m" : "www") + "/" + e.url,
                                  params: a,
                                  name: d,
                              ...
                              (c === "parent" || c === "opener") && ES("Object", "assign", !1, g.params, {
                                  channel_url: o._xdChannelHandler(f, c === "parent" ? "parent.parent" : "opener")
                              }, !0);
                              g = o.prepareParams(g);
                              return g
                          },
                          ...
                          getDisplayMode: function (a, c) {
                              ...
                              if (d && (b("sdk.modFeatureCheck").forIDs("force_popup_to_canvas_apps_with_id", [b("sdk.Runtime").getClientID()]) || b("sdk.feature")("force_popup_to_all_canvas_app", !1))) return "popup";
                              if (d && !c.display) return "async";
                              if (h(c) || i(c)) return "async";
                              if (b("sdk.UA").mobile() || c.display === "touch") return "touch";
                              if ((c.display == "iframe" || c.display == "dialog") && !o.canIframe(c)) {
                                  b("Log").error('"dialog" mode can only be used when the user is connected.');
                                  return "popup"
                              }
                              return a.connectDisplay && !d ? a.connectDisplay : c.display || (o.canIframe(c) ? "dialog" : "popup")
                          },
                          ...
                          popup: function (a) {
                              var c = b("sdk.Popup").popup(a, o.isOAuth({
                                  method: a.name
                              }));
                              c && (o.setLoadedNode(a, c, "popup"), a.id in o._defaultCb && o._popupMonitor())
                          },
                          ...
                          hidden: function (a) {
                              ...
                              a.root = b("sdk.Content").appendHidden(document.createElement("div")),
                              o._insertIframe(a)
                          },
                          iframe: function (a) {
                          ...
                          touch: function (a) {
                              ...
                              }, 0) : o.iframe(a) : b("sdk.UA").nativeApp() && !a.ui_created ? (a.frame = a.id, b("sdk.Native").onready(function () {
                                  o.setLoadedNode(a, b("sdk.Native").open(a.url + "#cb=" + a.frameName), "native")
                              }), o._popupMonitor()) : a.ui_created || o.popup(a)
                          },
                          async: function (a) {
                              ...
                              h(a.params) || i(a.params) ? (a.params.method = "oauth", a.params.redirect_uri = a.params.next, b("sdk.Extensions").remote.showDialog(a.params, c)) : b("sdk.RPC").remote.showDialog(a.params, c)
                          },
                          "native": function (a) {
                          ...
                          _triggerDefault: function (a, b) {
                              ...
                              b && (c.result = b);
                              o._xdRecv(c, o._defaultCb[a] ||
                              function () {})
                          },
                          _popupMonitor: function () {
                              var a;
                              for (var c in o._loadedNodes) if (Object.prototype.hasOwnProperty.call(o._loadedNodes, c) && c in o._defaultCb) {
                                  var d = function () {
                                      var d = o._loadedNodes[c];
                                      if (d.type != "popup" && d.type != "native") return "continue";
                                      var e = d.node;
                                      try {
                                          e.closed ? o.isOAuth(d) ? b("sdk.Auth").getLoginStatus(function (a) {
                                              ...
                                              }) : (a.status !== "connected" && (a.closeWindow = !0), o._triggerDefault(c, a))
                          ...
                          _xdRecv: function (a, c) {
                              ...
                              if (d) if (d.close) try {
                                  d.close(),
                                  /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(),
                                  o._popupCount--
                          ...
                          _xdResult: function (a, b, c, d) {
                              return o._xdNextHandler(function (b) {
                                  a && a(b.result && b.result != o._resultToken && ES("JSON", "parse", !1, b.result))
                              }, b, c, d) + "&result=" + encodeURIComponent(o._resultToken)
                          },
                          xdHandler: function (a, c, d, e, f, g, h) {
                              return o._xdNextHandler(b("sdk.Auth").xdResponseWrapper(a, e, f, h), c, d, g)
                          }
                      };
                  ...
                  __d("sdk.ui", ["Assert", "Log", "sdk.Impressions", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "sdk.feature"], (function (a, b, c, d, e, f) {
                      function a(a, c) {
                          ...
                          b("sdk.UIServer").isOAuth(d) && (a.display == "iframe" || a.display == "dialog") && (a.display = b("sdk.UIServer").checkOauthDisplay(a));
                          ...
                          e && (a.e2e = {});
                          a = b("sdk.UIServer").prepareCall(a, c ||
                          function () {});
                          if (!a) return null;
                  ...
                  __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], (function (a, b, c, d, e, f) {
                      ...
                      function a(a, b) {
                          ...
                          a || a === void 0 ? (g === null && (g = setInterval(function () {
                              j()
                  ...
                  __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.AppEvents", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.Frictionless", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function (a, b, c, d, e, f) {
                      ...
                      function h(a) {
                          ...
                          a.useFamilyLogin && b("sdk.Runtime").setShouldLoadFamilyLogin(!0);
                  ...
                  __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.feature"], (function (a, b, c, d, e, f) {
                      ...
                      if (h) {
                          ...
                          if (d.length > 1) if (d > 2) d = null;
                              ...
                              f && f instanceof HTMLIFrameElement && (c = f.contentWindow.performance.getEntriesByType("resource").find(function (a) {
                                  return ES(a.name, "startsWith", !0, k)
                              }));
                              d = d[0]
                          } else d = null;
                  ...
                  __d("XFBML", ["Assert", "Log", "runOnce", "sdk.Observable"], (function (a, b, c, d, e, f) {
                      ...
                      function m(a) {
                          var b = k(a, "className").split(/\s+/).filter(function (a) {
                      ...
                      function o(a, c, d) {
                          ...
                          var f = 1,
                              ...
                              h = function () {
                                  f--,
                                  f === 0 && (b("Log").info("XFBML Parsing Finish %s, %s tags found", e, g), c != null && c(), j.inform("render", [e, g])),
                          ...
                          ES("Array", "from", !1, a.getElementsByTagName("*")).forEach(function (a) {
                              ...
                              e.subscribe("render", b("runOnce")(function () {
                                  a.setAttribute("fb-xfbml-state", "rendered"),
                                  h()
                              }));
                              c = function b() {
                      ...
                      a = {
                          ...
                          parse: function (a, b) {
                              o((a = a) != null ? a : document.body, (a = b) != null ? a : function () {}, !0)
                          },
                          parseNew: function () {
                  ...
                  __d("sdk.PluginUtils", ["resolveURI", "sdk.Event"], (function (a, b, c, d, e, f) {
                      ...
                      function i(a, b, c) {
                          b === "100%" ? a.style.width = "100%" : b != null && b !== "" && (a.style.width = b + "px"),
                          (c != null && c !== "" || c === 0) && (a.style.height = c + "px")
                      }
                      function c(a) {
                          return function (c) {
                              c = {
                  ...
                  __d("IframePlugin", ["Log", "MPNLocalState", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "sdk.Auth", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.WebStorage", "sdk.XD", "sdk.createIframe"], (function (a, b, c, d, e, f) {
                      var g = b("Type").extend({
                          constructor: function (a, c, d, e) {
                              ...
                              this.subscribe("xd.resize.flow", function (a) {
                                  ...
                                  b("sdk.PluginUtils").resize(f._iframeOptions.root, b("sdk.PluginUtils").parse(a.width), b("sdk.PluginUtils").parse(a.height)),
                                  f.updateLift(),
                              ...
                              this.subscribe("xd.resize.iframe", function (a) {
                                  b("sdk.PluginUtils").resize(f._iframe, b("sdk.PluginUtils").parse(a.width), b("sdk.PluginUtils").parse(a.height)),
                                  f._isIframeResized = !0,
                                  f.updateLift(),
                                  window.clearTimeout(f._timeoutID)
                              });
                          ...
                          process: function () {
                              ...
                              this.subscribe("render", function () {
                                  ...
                                  a._isIframeResized || b("sdk.PluginUtils").collapseIframe(a._iframe)
                              });
                              ...
                              this._timeoutID = window.setTimeout(function () {
                                  ...
                                  b("Log").warn("%s:%s failed to resize in %ss", a._ns, a._tag, e)
                              }, e * 1e3);
                  ...
                  __d("getFacebookOriginForTarget", ["Log"], (function (a, b, c, d, e, f) {
                      ...
                      function a(a, c) {
                          ...
                          window.addEventListener("message", function (d) {
                              d.source === c && d.data.xdArbiterAck && (/\.facebook\.com$/.test(d.origin) && /^https:/.test(d.origin) ? e === !1 && (e = !0, b("Log").debug("initXdArbiter got xdArbiterAck from " + d.origin), a(d.origin)) : b("Log").error("xdAbiterAck was not from Facebook: ", d.origin))
                          }, !1);
                          c.postMessage({
                              xdArbiterSyn: !0
                          }, "*");
                          d = window.setInterval(function () {
                              !e && f > 0 ? (f--, b("Log").debug("resending xdArbiterSyn"), c.postMessage({
                                  xdArbiterSyn: !0
                  ...
                  __d("sdk.XFBML.CustomerChat", ["DOMEventListener", "IframePlugin", "MPNLocalState", "UrlMap", "getFacebookOriginForTarget", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.WebStorage", "sdk.XD", "sdk.createIframe"], (function (a, b, c, d, e, f) {
                      ...
                      var g = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                          ...
                          F = b("IframePlugin").extend({
                              ...
                              _setUpSubscriptions: function () {
                                  var a = this;
                                  this.subscribe("xd.liveChatPluginResizeIframeVariableHeight", function (b) {
                                      b.setBoxShadow ? a._handleSetIframeBoxShadow() : a._handleUnsetIframeBoxShadow(),
                                      a._handleResizeIframe(b)
                                  });
                                  this.subscribe("xd.liveChatPluginUpdateShadow", function (b) {
                                      a._handleShadowUpdate(b)
                                  });
                                  this.subscribe("xd.liveChatPluginUpdatePageTitle", function (b) {
                                      a._handleUpdatePageTitle(b)
                                  });
                                  b("sdk.UA").iphone() && this.subscribe("xd.liveChatPluginBlurComposer", function (b) {
                              ...
                              _handleSetAppearance: function (a) {
                                  ...
                                  if (a.shouldSetHidden == "true") {
                                      ...
                                      A = f;
                                      D = e == "true";
                                      e == "true" ? (this._iframe.style.removeProperty("animation"), this._handleHideDialogIframe({
                                          chatStarted: c,
                                          isMobile: d,
                                          alignment: b
                                  ...
                                  a.shadow != null && this._handleShadowUpdate({
                                      resetShadow: a.shadow
                                  })
                              },
                              _handlePrepareIframe: function (a) {
                                  ...
                                  if (k && a.isMobile === "true" && !D && A == w) {
                                      var c = M(a.isMobile === "true", "right");
                                      c != null && b("sdk.DOM").addCss(q, c)
                                  }
                                  a.isMobile === "true" && !D && A != w && A != y && K();
                                  E && F.hide()
                              },
                              ...
                              _handleResizeIframe: function (a) {
                                  this._iframe && b("sdk.DOM").setStyle(this._iframe, "height", ES("JSON", "parse", !1, a.height) + "px")
                              },
                              _handleSetIframeBoxShadow: function () {
                                  this._iframe && (b("sdk.DOM").setStyle(this._iframe, "boxShadow", "0 1pt 12pt grey"), b("sdk.DOM").setStyle(this._iframe, "margin", "12px"))
                              },
                              _handleUnsetIframeBoxShadow: function () {
                                  this._iframe && (b("sdk.DOM").setStyle(this._iframe, "boxShadow", "none"), b("sdk.DOM").setStyle(this._iframe, "margin", "0px 12px"))
                              },
                              _handleShowDialogIframe: function (a) {
                                  O(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile), !0, a.alignment)
                              },
                              _handleHideDialogIframe: function (a) {
                                  P(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile), !0, a.alignment)
                              },
                              ...
                              _handleUpdatePageTitle: function (a) {
                                  var c = this;
                                  !j && a.titleText ? (j = b("sdk.DocumentTitle").blink(a.titleText), b("DOMEventListener").add(window, "focus", function (a) {
                                      c._stopBlinking()
                              ...
                              _notifyDialogFrame: function () {
                                  ...
                                  I({
                                      ...
                                      frameName: B ? t : null,
                                      unreadCountFrameName: C ? u : null,
                                      iconSrc: (a = m) == null ? void 0 : a.src,
                                      unreadSrc: (a = l) == null ? void 0 : a.src
                                  })
                              },
                              _getBubbleFrameURL: function () {
                                  return b("sdk.Runtime").getIsVersioned() ? b("UrlMap").resolve("www") + "/" + b("sdk.Runtime").getVersion() + "/plugins/customer_chat/bubble" : ""
                              },
                      ...
                      function G(a, c) {
                          ...
                          s === null ? b("getFacebookOriginForTarget")(function (a) {
                              s = a,
                              d(s)
                          }, window.frames[a]) : d(s)
                      }
                      ...
                      function O(a, c, d, e, f) {
                          ...
                          if (v === null || v === !1) {
                              ...
                              d ? (b("sdk.DOM").setStyle(a, "maxHeight", "100%"), b("sdk.DOM").setStyle(a, "width", "100%")) : (b("sdk.DOM").setStyle(a, "maxHeight", "calc(100% - 80px)"), b("sdk.DOM").setStyle(a, "minHeight", "360px"));
                              I({
                      ...
                      function P(a, c, d, e, f) {
                          ...
                          if (v === null || v === !0) {
                              d && (c || A !== w) && L();
                              if (!k) b("sdk.DOM").setStyle(i, "maxHeight", "0"),
                              b("sdk.DOM").setStyle(i, "minHeight", "0"),
                              v = !1;
                              else {
                                  var j = function a(c) {
                                      D && (b("sdk.DOM").setStyle(i, "maxHeight", "0"), b("sdk.DOM").setStyle(i, "minHeight", "0"), g.forEach(function (c) {
                      ...
                      F.show = function (a) {
                          a === void 0 && (a = !0),
                          E = !1,
                          n != null && b("sdk.DOM").setStyle(n, "display", "inline"),
                          a && (D = !1, O(q, o, b("sdk.UA").mobile(), !1)),
                          b("sdk.Event").fire("customerchat.show"),
                          J("show")
                      };
                      F.hide = function () {
                          E = !0,
                          n != null && b("sdk.DOM").setStyle(n, "display", "none"),
                          D = !0,
                          P(q, o, b("sdk.UA").mobile(), !1),
                      ...
                      F.showDialog = function () {
                          n != null && b("sdk.DOM").setStyle(n, "display", "inline"),
                          D = !1,
                          O(q, o, b("sdk.UA").mobile()),
                          J("showDialog")
                      };
                      F.hideDialog = function () {
                          D = !0,
                          P(q, o, b("sdk.UA").mobile()),
                          J("hideDialog")
                      };
                      F.update = function (a) {
                          b("sdk.XD").sendToFacebook(r, {
                  ...
                  __d("sdk.XFBML.Quote", ["DOMEventListener", "IframePlugin", "containsNode", "sdk.DOM", "sdk.UA", "sdk.XD", "sdk.feature"], (function (a, b, c, d, e, f) {
                      ...
                      function q(a) {
                          ...
                          if (c) {
                              var d = !1;
                              for (var e = 0; e < c; e++) if (b("containsNode")(l[e], a.focusNode)) {
                                  d = !0;
                                  break
                              }
                              if (!d) return
                      ...
                      a = b("IframePlugin").extend({
                          constructor: function (a, c, d, e) {
                              ...
                              l = ES("Array", "from", !1, document.getElementsByTagName("*")).filter(function (a) {
                  ...
                  __d("sdk.XFBML.Save", ["IframePlugin", "UrlMap", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.createIframe"], (function (a, b, c, d, e, f) {
                      ...
                      a = b("IframePlugin").extend({
                          ...
                          positionOnScreen: function (a, c) {
                              ...
                              } else b("sdk.DOM").setStyle(a, "position", "fixed"),
                      ...
                      a = b("IframePlugin").extend({
                          constructor: function (a, c, d, e) {
                              ...
                              this.subscribe("xd.onVideoAPIReady", function (a) {
                                  ...
                                  this._videoController = new h(this._iframeOptions.name, this._sharedObservable, this._sharedVideoCache),
      ...
      i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1003960439","namespace":"FB","message":"' + e.message + '"}}');
